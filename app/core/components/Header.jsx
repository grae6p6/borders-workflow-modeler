                    ...
                    <div className="header-proposition">
                        <div className="content">
                            ...
                            <nav id="proposition-menu">
                                <a id="proposition-name" onClick={() => this.props.history.replace('home')}>Process
                                    Modeler</a>
                                <ul id="proposition-links">
                                    <li><a onClick={() => this.props.history.replace('bpmn')}
                                           className={currentRoute === '/bpmn' ? 'active' : ''}>BPMN</a></li>
                                    <li><a onClick={() => this.props.history.replace('cmmn')}
                                           className={currentRoute === '/cmmn' ? 'active' : ''}>CMMN</a></li>
                                    <li><a onClick={() => this.props.history.replace('dmn')}
